...
import type { LegalDocumentDto, LegalDocumentRequest } from '../zod';
...
export const delete1 = (id: string, signal?: AbortSignal) => {
...
export const listByVehicle = (vehicleId: string, signal?: AbortSignal) => {
  return orvalInstance<LegalDocumentDto[]>({
    url: `/v1/legal-documents/vehicles/${vehicleId}`,
    method: 'GET',
    signal,
  });
};
...
export const getListByVehicleQueryKey = (vehicleId: string) => {
  return [`/v1/legal-documents/vehicles/${vehicleId}`] as const;
};

export const getListByVehicleQueryOptions = <
  TData = Awaited<ReturnType<typeof listByVehicle>>,
  TError = unknown,
>(
  vehicleId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof listByVehicle>>, TError, TData>
    >;
  }
) => {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListByVehicleQueryKey(vehicleId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listByVehicle>>> = ({
    signal,
  }) => listByVehicle(vehicleId, signal);
...
export type ListByVehicleQueryResult = NonNullable<
  Awaited<ReturnType<typeof listByVehicle>>
>;
export type ListByVehicleQueryError = unknown;

export function useListByVehicle<
  TData = Awaited<ReturnType<typeof listByVehicle>>,
  TError = unknown,
>(
  vehicleId: string,
