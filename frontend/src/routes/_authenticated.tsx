...
function AuthenticatedLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F1F5F9]">
      {/* Sidebar */}
      <aside
        className="w-[208px] shrink-0 bg-white flex flex-col border-r border-slate-100"
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          <p className="px-3 mb-2 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Main Menu</p>
        ...
        <div className="px-3 py-4 border-t border-slate-100 space-y-2">
          ...
          <button className="w-full bg-[#0052CC] hover:bg-[#003d99] text-white text-xs font-semibold px-3 py-2.5 rounded-lg transition-colors cursor-pointer flex items-center justify-center gap-1.5">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* TopBar */}
        <header className="h-14 bg-white border-b border-slate-100 flex items-center px-6 gap-4 shrink-0" style={{ boxShadow: '0 1px 4px 0 rgba(0,0,0,0.04)' }}>
          {/* Search */}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:block">
              <p className="text-xs font-semibold text-[#0F172A] leading-tight">{email ?? 'User'}</p>
              <p className="text-[10px] text-slate-400 leading-tight">{role ? (roleLabelMap[role] ?? role) : 'Member'}</p>
            </div>
          </div>
        </header>
...
function NavItem({
  ...
  return (
    <Link
      ...
      activeProps={{
        className: 'flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium bg-[#E6F0FF] text-[#0052CC]',
      }}
      inactiveProps={{
        className: 'flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-slate-800',
      }}
    >
      {children}
      <span>{label}</span>
